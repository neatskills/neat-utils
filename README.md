...
**neat-util-business-analysis** — Business analysis for startup founders evaluating new business ideas. Guides through clarifying questions, framework selection, analysis, and creates structured business plans.
...
```bash
# Install
./scripts/install.sh pdf insights lint business-analysis

# Uninstall
./scripts/uninstall.sh pdf insights lint business-analysis
```
